...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command('check:expired-users')->everyMinute()->onOneServer()->withoutOverlapping(10)->runInBackground();
        // reset
        ...
        $schedule->command('sync:device-state')->everyMinute()->onOneServer()->withoutOverlapping(5);
        // backup Timing
